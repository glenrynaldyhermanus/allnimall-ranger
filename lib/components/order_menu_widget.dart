...
import '../edit_customer_for_order/edit_customer_for_order_widget.dart';
import '../edit_order_information/edit_order_information_widget.dart';
import '../edit_order_schedule/edit_order_schedule_widget.dart';
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => EditCustomerForOrderWidget(
                              order: widget.order,
                            ),
                          ),
                        );
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => EditOrderInformationWidget(
                              order: widget.order,
                            ),
                          ),
                        );
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => EditOrderScheduleWidget(
                              order: widget.order,
                            ),
                          ),
                        );
