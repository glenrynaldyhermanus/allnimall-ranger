              ...
              child: Row(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      setState(() =>
                          FFAppState().filterDate = DateTime(calendarSelectedDay!.end.year,calendarSelectedDay!.end.month, calendarSelectedDay!.end.day, DateTime.now().hour, DateTime.now().minute, DateTime.now().second ));
