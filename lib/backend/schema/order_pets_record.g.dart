...
class _$OrderPetsRecord extends OrderPetsRecord {
  ...
  factory _$OrderPetsRecord([void Function(OrderPetsRecordBuilder) updates]) =>
      (new OrderPetsRecordBuilder()..update(updates)).build();

  _$OrderPetsRecord._({this.orderUid, this.petUid, this.reference}) : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc(0, orderUid.hashCode), petUid.hashCode), reference.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('OrderPetsRecord')
...
class OrderPetsRecordBuilder
  ...
  @override
  _$OrderPetsRecord build() {
    final _$result = _$v ??
        new _$OrderPetsRecord._(
            orderUid: orderUid, petUid: petUid, reference: reference);
    replace(_$result);
    return _$result;
  }
}
