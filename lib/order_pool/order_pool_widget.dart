...
class OrderPoolWidget extends StatefulWidget {
  const OrderPoolWidget({Key key}) : super(key: key);

  @override
  _OrderPoolWidgetState createState() => _OrderPoolWidgetState();
}

class _OrderPoolWidgetState extends State<OrderPoolWidget> {
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0, 4, 8, 0),
                                          child: AutoSizeText(
                                            listViewOrdersRecord.customerAddress
                                                .maybeHandleOverflow(
                                              maxChars: 70,
                                              replacement: '…',
                                            ),
