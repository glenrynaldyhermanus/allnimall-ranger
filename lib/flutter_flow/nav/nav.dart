...
class AppStateNotifier extends ChangeNotifier {
  GroomerFirebaseUser? initialUser;
  GroomerFirebaseUser? user;
  ...
  void update(GroomerFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'OrderRequest')
                  : OrderRequestWidget(),
            ),
            FFRoute(
              name: 'RequestDetail',
            ...
            FFRoute(
              name: 'RateCommentList',
              path: 'rateCommentList',
              requireAuth: true,
            ...
            FFRoute(
              ...
              path: 'noman',
              requireAuth: true,
              builder: (context, params) => NomanWidget(),
            )
