...
class OrderDetailCopyWidget extends StatefulWidget {
  ...
  @override
  _OrderDetailCopyWidgetState createState() => _OrderDetailCopyWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<OrdersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final orderDetailCopyOrdersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          ...
          appBar: AppBar(
            ...
            actions: [
              Row(
                ...
                children: [
                  if ((orderDetailCopyOrdersRecord.status) != 'Finish')
                          ...
                          builder: (context) {
                            return Padding(
                              ...
                              child: CancelationReasonsWidget(
                                order: orderDetailCopyOrdersRecord,
                              ),
                            );
                          },
                        );
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          if ((orderDetailCopyOrdersRecord
                                                  .status) ==
                                              'OnTheWay')
                                            Expanded(
                                              flex: 1,
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            if ((orderDetailCopyOrdersRecord.status) ==
                                'Confirmed')
                              Expanded(
                                child: FFButtonWidget(
                                  onPressed: () async {
