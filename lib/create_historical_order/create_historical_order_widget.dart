...
class CreateHistoricalOrderWidget extends StatefulWidget {
  const CreateHistoricalOrderWidget({Key key}) : super(key: key);

  @override
  _CreateHistoricalOrderWidgetState createState() =>
      _CreateHistoricalOrderWidgetState();
}

class _CreateHistoricalOrderWidgetState
    extends State<CreateHistoricalOrderWidget> {
  DateTime datePicked;
